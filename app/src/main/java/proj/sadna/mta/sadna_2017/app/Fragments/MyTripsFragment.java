...
public class MyTripsFragment extends Fragment implements IOnPathSave
{
    ...
    {// Inflate the layout for this fragment
        ...
        dataPath = PathModelRec.getMine();
        this.mAdapter = new MyTripsFragment.TopTripsAdapter(dataPath);
    ...
    public class TopTripsAdapter extends BaseSwipListAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            if (convertView == null)
            {
                ...
                new MyTripsFragment.ViewHolder(convertView);
            }

            MyTripsFragment.ViewHolder holder = (MyTripsFragment.ViewHolder) convertView.getTag();
